    ...
    <form class="fllist">
        ...
        <div class="cztable">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
                ...
                <c:forEach items="${pi.list}" var="in">
                <tr>
                <td><img src='../Images/FileIco/doc.gif' /></td>
                    ...
                    <td>
                        <a href="/study/download?fname=${filename}">下载</a>
                ...
                <tr>
                    <td colspan="20" style="text-align: center;">
                        ...
                        <fy:fy url="/study/getdownlist?informationname=${iname}" pageInfo="${pi}"></fy:fy>
                    ...
                    <script type="text/javascript">
                        $(function(){
                            $("[name=num]").change(function(){
                                var size=$(this).val();
                                location.href="/book/download?size="+size;
                            });
                        })
                    </script>
                    </td>
